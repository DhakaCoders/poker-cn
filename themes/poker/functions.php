...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'poker');
    ...
    function cbv_theme_setup(){
      ...
      load_theme_textdomain( 'poker', get_template_directory() . '/languages' );
        ...
        register_nav_menus( array(
            'cbv_main_menu' => __( 'Main Menu', 'poker' ),
            'cbv_mobile_menu' => __( 'Mobile Menu', 'poker' )
        ) );
...
if( function_exists('acf_add_options_page') ) { 
    ...
    acf_add_options_page(array(
        'page_title'    => __('Options', 'poker'),
        'menu_title'    => __('Options', 'poker'),
