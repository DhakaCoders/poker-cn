...
function cptui_register_my_cpts_poker_sites() {

  /**
   * Post Type: Poker Sites.
   */

  $labels = [
    "name" => __( "Poker Sites", "poker" ),
    "singular_name" => __( "Poker Site", "poker" ),
  ];

  $args = [
    "label" => __( "Poker Sites", "poker" ),
    "labels" => $labels,
    "description" => "",
    "public" => true,
    ...
    "map_meta_cap" => true,
    "hierarchical" => false,
    "rewrite" => [ "slug" => "poker_sites", "with_front" => true ],
    "query_var" => true,
  ...
  register_post_type( "poker_sites", $args );
}

add_action( 'init', 'cptui_register_my_cpts_poker_sites' );
